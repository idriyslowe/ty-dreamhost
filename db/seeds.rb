...
# Post.create!([
#   {
#     heading: "**New Website! C2E2 This weekend!**",
...
#     in_store: true,
#       images_attributes: [
#         {uploaded_image: Pathname.new('public/uploads/comic/series_image/Gary-Series.jpg').open, image_type: :cover, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/gary-1.jpg').open, image_type: :cover, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/gary-2.jpg').open, image_type: :page, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/gary-3.jpg').open, image_type: :page, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/gary-4.jpg').open, image_type: :page, page: nil},
...
#     in_store: true,
#       images_attributes: [
#         {uploaded_image: Pathname.new('public/uploads/issues/Simon_CollectionCover.jpg').open, image_type: :cover, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/7-Simon_LifeOfTheMind.jpg').open, image_type: :page, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/Simon_Combat-2.jpg').open, image_type: :page, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/Simon_Hammer-1.jpg').open, image_type: :page, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/Simon_SimpleSimon-5.jpg').open, image_type: :page, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/Simon_Symmetry-4.jpg').open, image_type: :cover, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/Simon-repair.jpg').open, image_type: :page, page: nil},
#         {uploaded_image: Pathname.new('public/uploads/issues/Simon-repair2.jpg').open, image_type: :page, page: nil}
#       ]
#   }
# ])
...
PortfolioItem.create!([
  {
    title: "1-victus4-Cover.jpg",
    details: "pin-up",
    image: Pathname.new("public/uploads/portfolio/1-victus4-Cover.jpg").open,
    year: "2015"
  },
  {
    title: "2-victus4-11 copy.jpg",
    details: "pin-up",
    image: Pathname.new("public/uploads/portfolio/2-victus4-11 copy.jpg").open,
    year: "2015"
  },
  {
    title: "3-victus4-13-14spread.jpg",
    details: "pin-up",
    image: Pathname.new("public/uploads/portfolio/3-victus4-13-14spread.jpg").open,
    year: "2015"
  },
  {
    title: "4-TheThing-2.jpg",
    details: "pin-up",
    image: Pathname.new("public/uploads/portfolio/4-TheThing-2.jpg").open,
    year: "2015"
  },
  {
    title: "5-DOOM.jpg",
  ...
  {
    title: "6-TheTorch.jpg",
    details: "pin-up",
    image: Pathname.new("public/uploads/portfolio/6-TheTorch.jpg").open,
    year: "2015"
  },
  {
    title: "7-WP_5r.jpg",
    details: "page",
    image: Pathname.new("public/uploads/portfolio/7-WP_5r.jpg").open,
    year: "2015"
  },
  {
    title: "8-WP_8r.jpg",
    details: "page",
    image: Pathname.new("public/uploads/portfolio/8-WP_8r.jpg").open,
    year: "2015"
  },
  {
    title: "9-Kusanagi.jpg",
    details: "pin-up",
    image: Pathname.new("public/uploads/portfolio/9-Kusanagi.jpg").open,
    year: "2015"
  },
  {
    title: "10-Space-Mullet-Pinup.jpg",
    details: "pin-up",
    image: Pathname.new("public/uploads/portfolio/10-Space-Mullet-Pinup.jpg").open,
    year: "2015"
  },
  {
    title: "11-Cable2.jpg",
    details: "cover",
    image: Pathname.new("public/uploads/portfolio/11-Cable2.jpg").open,
    year: "2015"
  },
  ...
  # },
  {
    title: "12-Paybacks-bloodpouch.jpg",
    details: "cover",
    image: Pathname.new("public/uploads/portfolio/12-Paybacks-bloodpouch.jpg").open,
    year: "2015"
  },
  # {
  #   title: "Refugee.jpg",
  ...
  # },
  {
    title: "13-TheThing1.jpg",
    details: "zine cover",
    image: Pathname.new("public/uploads/portfolio/13-TheThing1.jpg").open,
    year: "2015"
  },
  {
    title: "14-SR3 Poster-Color.jpg",
    details: "cover",
    image: Pathname.new("public/uploads/portfolio/14-SR3 Poster-Color.jpg").open,
    year: "2015"
  }
  # {
  #   title: "victus4-coverPRINT.jpg",
  #   details: "cover",
  #   image: Pathname.new("public/uploads/portfolio/victus4-coverPRINT.jpg").open,
  #   year: "2014"
  # }
])
...
# <img alt=\"\" border=\"0\" src=\"https://www.paypalobjects.com/en_US/i/scr/pixel.gif\" width=\"1\" height=\"1\">
# </form>",
#     image: Pathname.new("public/uploads/portfolio/DOOM1.jpg").open
#   }
# ])
...
#   image: Pathname.new('public/uploads/about/BIOTY.jpg').open
# )